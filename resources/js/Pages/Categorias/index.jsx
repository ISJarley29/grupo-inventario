...
export default function Index({ auth, categorias }) {
  // 🔍 DEBUG: Borra esta línea cuando confirmes que los datos se ven en la tabla
            ...
            <table className="w-full border-collapse border border-gray-200 rounded-lg overflow-hidden">
              ...
              <tbody>
                {categorias.length === 0 ? (
                  ...
                  categorias.map((cat) => (
                    /* 💡 Nota: Si tu llave primaria en la BD no es 'id' sino 'id_categoria', cámbialo aquí abajo */
                    <tr key={cat.id || cat.id_categoria} className="hover:bg-gray-50 text-gray-600">
                      <td className="border-b p-3">{cat.id || cat.id_categoria}</td>
